---
description: |
  Stage 1 of /klp-design. Parses a YAML request, maps each screen to DS
  components, flags ad-hoc needs and DS gaps. Produces
  .klp/staging/<id>/plan.json. Does not write consumer source.
mode: subagent
temperature: 0.2
forge-level: project
forge-role: producer
