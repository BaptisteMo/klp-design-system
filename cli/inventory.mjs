...
export function writeInventoryMd(rootDir, inventory) {
  ...
  lines.push('')
  lines.push(`> **Canonical CLI invocation** (run from this repo root): \`npx klp-ui add <name>\`, \`npx klp-ui list\`, \`npx klp-ui update\`. The \`klp-ui\` bin is provided by the \`@klp/ui\` devDependency in \`package.json\` — no global install or PATH setup needed.`)
  lines.push('')
  ...
  if (byStatus.installed.length === 0) {
    lines.push('_None yet. Run `npx klp-ui add <name>` to install a component._')
    lines.push('')
  } else {
